...
This separation is what makes transports swappable. The same email channel works with SMTP, Resend, or a mock — because they all accept `RenderedMessage`. See [Transports](/docs/concepts/transports) for how delivery works.
