...
- Read [Catalog & Procedures](../concepts/catalog-and-routes.mdx) for deeper coverage of procedure composition and dot-path route IDs.
- Read [Transports Overview](../transports/index.mdx) to learn about multi-transport composition and failover.
- Read [Middleware](../concepts/middleware.mdx) when you want rate limits, tracing, or event logging across procedures.
