...
console.log(`[marketing.newsletter] messageId: ${newsletter.messageId}`);
```
...
- Read [Catalog & Procedures](/docs/concepts/catalog-and-procedures) for deeper coverage of procedure composition and dot-path route IDs.
