...
- Read [Multi-Transport](/docs/transports/generic/multi-transport) for other strategies such as `round-robin`, `race`, and `parallel`.
- Read [Middleware](/docs/concepts/middleware) for the middleware execution model and where plugin middleware fits.
