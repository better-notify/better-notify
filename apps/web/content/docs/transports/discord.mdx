...
The Discord transport is included in `@betternotify/discord`. It calls the [Discord Webhook API](https://discord.com/developers/docs/resources/webhook#execute-webhook) via `fetch` — no external HTTP dependencies required (Node 22+ / Bun built-in).
