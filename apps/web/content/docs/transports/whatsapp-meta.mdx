...
The WhatsApp Meta transport is included in `@betternotify/whatsapp`. It calls the [Meta WhatsApp Cloud API](https://developers.facebook.com/documentation/business-messaging/whatsapp/overview) via `fetch` — no external SDK dependencies required (Node 22+ / Bun built-in).
