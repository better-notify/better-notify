...
Amazon SES exposes a standard SMTP interface. Use the [`@betternotify/smtp`](/docs/transports/smtp) transport with your SES SMTP credentials — no separate package needed.
...
- [SMTP transport options](/docs/transports/smtp) for pool, DKIM, and advanced Nodemailer settings.
- [Multi-Transport](/docs/transports/multi-transport) for failover between SES and another provider.
