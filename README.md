...
End-to-end typed email infrastructure for Node.js. Define email contracts once, get a typed sender, queue worker, and webhook router — all driven by the same router type.
